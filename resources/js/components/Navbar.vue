<template>
    <div>
            ...
            <div class="subnavbar">
                <div class="container">
                    ...
                    <div class="right-side">
                        <ul class="pulp-list">
                            <span v-if="!isLoggedIn" class="material-icons-sharp ml-2">person_add</span>
                            <li v-if="!isLoggedIn" class="pulp-list-group">
                                <router-link :to="{ name: 'register' }">Register</router-link>
                                |
                            </li>
                            <span v-if="!isLoggedIn" class="material-icons-sharp ml-2">person_outline</span>
                            <li v-if="!isLoggedIn" class="pulp-list-group">
                                <router-link :to="{ name: 'login' }">Login</router-link>
                            </li>
                            <span v-if="isLoggedIn" class="material-icons-sharp ml-2">inventory</span>
                            <li style="cursor: pointer" v-if="isLoggedIn" class="pulp-list-group">
                                <router-link :to="{ name: 'myorders' }">Orders</router-link>
                            </li>

                            <span v-if="isLoggedIn" class="material-icons-sharp ml-2">logout</span>
                            <li style="cursor: pointer" v-if="isLoggedIn" @click="logout" class="pulp-list-group">
                                Logout
                            </li>
                        </ul>
                    </div>
            ...
            <div class="mid-navbar">
                ...
                -->
                                <a data-toggle="modal" data-target="#exampleModal"
                                    style="color: #363949; cursor: pointer"><span
                                        class="material-icons-sharp ml-2">shopping_cart</span>{{ this.cart.length }}</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="item in cart" :key="item.id">
                                    ...
                                    <td>{{ item.price }}</td>
                                    <td>
                                        <button @click="removeCart(item.id)" class="btn btn-danger btn-sm">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" @click="Checkout" data-dismiss="modal" class="btn btn-primary">
                            Checkout
                        </button>
                    </div>
                </div>
        ...
        <section class="top-mobile">
            <nav class="navbar navbar-light bg-light">
                ...
                <div class="account float-right mr-4">
                    <span style="cursor: pointer" data-toggle="modal" data-target="#exampleModal5"
                        class="material-icons-sharp">search</span>
        ...
        prod.name
                    ...
                    <small class="account-button"><span class="material-icons-sharp ml-2">person_outline
                        </span></small>
                    <ul class="account-dropdown-mobile" style="z-index: 99999999">
                        ...
                        <li v-if="isLoggedIn" style="cursor: pointer" @click="logout">
                            <i class="fa-solid fa-right-from-bracket"></i>
                            Logout
                        </li>
                    </ul>
                    <a href="#" data-toggle="modal" data-target="#exampleModal" style="color: #363949"><span
                            class="material-icons-sharp ml-2">shopping_cart</span>{{ this.cart.length }}</a>
                </div>
            </nav>
                    ...
                    <ul class="list-unstyled components">
                        <li v-for="(category, index) in categories" :key="index">
                            ...
                            <ul class="collapse list-unstyled" id="homeSubmenu">
                                ...
                                <li v-for="(
                                        subcategory, index
                                    ) in category.subcategories" :key="index">
                                    <router-link :to="{
                            ...
                            <ul class="submenu">
                                <li v-for="(category, index) in categories" :key="index">
                                    ...
                                    <ul class="submenu">
                                        <li v-for="(
                                                subcategory, ind
                                            ) in category.subcategories" :key="ind">
                                            <router-link :to="{
                                                name: 'browseBySubcategory',
                ...
                <div class="container text-center text-md-start mt-5">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                            ...
                            <p>
                                <i class="fas fa-phone me-3"></i>{{ this.settings.phone_number }}
                            </p>
                        </div>
                        <!-- Grid column -->
                    </div>
...
export default {
    ...
    methods: {
        ...
        search() {
            axios
                .get("/api/search/products?searching=" + this.searching)
                .then((res) => {
