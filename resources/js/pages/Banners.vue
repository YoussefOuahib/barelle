<template>
  ...
  <tbody>
     <tr v-for="banner in banners.data" :key="banner.id">
      ...
      <td class="banner-pic"><img width="100px" height="100px" :src="'/banenrs/' + banner.picture" alt=""></td>
       <td>{{banner.title}}</td>
       <td>{{banner.link}}</td>
        <td>{{banner.order}}</td>
...
<img v-if="this.prv != ''" style="cursor:pointer; margin: 0 auto" :src="'/banners/' + this.prv" height="150px" width="150px">
