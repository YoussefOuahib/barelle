...
<div class="modal-vue">
  ...
  <div class="modal" v-if="showupdateModal">
    ...
    <img v-if="this.prv != ''" style="cursor:pointer; margin: 0 auto" :src="'/products/' + this.prv" height="150px" width="150px">
...
<input style="display: none" type="file" id="image"  @change="handleOnChange"/>
        ...
        <div id="wrapper" class="wrapper" >
         ...
         <div v-for="(img,index) in this.product.gallery" :key="img.id" class="wrapper-images">
            <img  style="border-radius: 10px" :src="'/products/' + img.image" height="70px" width="70px">
