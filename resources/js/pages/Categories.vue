              ...
              <tr v-for="(category, index) in categories.data" :key="index">
                ...
                <td>
                  <button style="background: transparent;" type="button"
                    @click="getCategory(category.id); showupdateModal = true;"><span style="cursor: pointer;"
                      class="primary material-icons-sharp">edit</span></button>
                  <button style="background: transparent;" type="button" @click="deleteCategory(category.id)"><span
      ...
      <div class="modal" style="width: 70%; top: 140px; left: 120px;" v-if="showModal">
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" @click="addCategory()" class="btn btn-primary"> <i
    ...
    <div class="modal-vue">
      ...
      <div class="modal" style="width: 70%; top: 140px; left: 120px;" v-if="showupdateModal">
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" @click="updateCategory(category.id)" class="btn btn-primary"> <i
