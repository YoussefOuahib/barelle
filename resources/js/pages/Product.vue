...
<div class="details mt-4">
  ...
  <div>
    <img :src="'/products/' + this.product.image" width="60%">
    ...
    <img  v-for="(gal,index) in this.product.gallery" :key="index" :src="'/products/' + gal.image" width="100px" height="100px">
        ...
        <div v-for="prod in related.data" :key="prod.id" class="col-lg-3 col-md-6 col-sm-6 col-12">
          <div class="wsk-cp-product">
            <div class="wsk-cp-img">
              <img :src="'/products/' + prod.image"  class="img-responsive" />
            </div>
