    ...
    <main>
      ...
      <div class="inline-form">
        ...
        <div class="myform">
          ...
          <div>
            <input type="text" placeholder="leave it bland if you have no office" v-model="settings.address"
              class="inputform">
          </div>
      ...
      <div class="myform" style="text-align:center">
        ...
        <div>
          <label for="image" class="myimg">
            ...
            <img style="cursor:pointer;margin: 0 auto;" :src="'/storage/images/' + this.previewImg" height="150px"
              width="150px">
      ...
      <div class="myform">
        ...
        <div>
          <input type="text" required v-model="settings.header_text" placeholder="Welcome to our Store"
            class="inputform">
        </div>
      </div>
      ...
      <div class="myform">
        ...
        <div>
          <textarea class="inputform" v-model="settings.footer_description" required
            placeholder="write a short description about your business" cols="20"></textarea>
      ...
      <div class="myform">
        ...
        <div>
          <input type="text" required v-model="settings.newsletter_header" placeholder="Subscribe to our newsletter .."
            class="inputform">
        </div>
      </div>
      <div class="myform">
        ...
        <div>
          <input type="text" required v-model="settings.newsletter_text" placeholder="don't miss our updates .."
            class="inputform">
        </div>
      </div>
      <button type="button" @click="insertSettings()" class="btn btn-primary"> <i
          class="fa-light fa-plus"></i>Submit</button>
    </main>
  </div>
</template>
<script>
